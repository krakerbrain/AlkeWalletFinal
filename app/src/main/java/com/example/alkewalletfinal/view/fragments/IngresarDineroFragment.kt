...
import com.example.alkewalletfinal.databinding.FragmentIngresarDineroBinding
                ...
                if (token != null) {
                    ...
                    loginViewModel.accountDetailsUpdated.observe(viewLifecycleOwner) { isUpdated ->
                        if (isUpdated) {
                            ...
                            findNavController().navigate(R.id.action_ingresarDineroFragment_to_homePageFragment)
                        } else {
